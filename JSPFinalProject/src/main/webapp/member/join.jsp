      ...
      <table class="table">
        <tr>
          ...
          <td width =85% class="inline">
           <input type = text name =id  id =join_id size=30 class="input-sm" readonly> <!-- readonly : 사용자 수정 불가능 -->
 		   <input type =button id="checkBtn" value ="아이디 중복 체크" class="btn btn-sm btn-primary">    
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width =85% class="inline">
 		   <input type =text  id =post size=30 class="input-sm" readonly>
        ...
        <tr>
          ...
          <td width =85%>
 		   <input type =text  name =addr2 id =addr2 size=95 class="input-sm" readonly>
 		  </td>
        </tr>
        <tr>
          ...
          <td width =85% class="inline">
 		   ...
 		   <input type =button  name =tBtn  class="btn btn-sm btn-info" value="전화 확인">
